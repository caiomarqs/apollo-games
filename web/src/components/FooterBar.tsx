        ...
        <div className="container noselect">
          <div className="footer-items row ">
            ...
            <ul className="nav flex-column col">
              ...
              <li className="nav-item">
                <a
                  className="btn-font footer-link"
                  href="https://twitter.com/ApolloGamesLab"
                  target="_blank"
              ...
              <li className="nav-item">
                <a
                  className="btn-font footer-link"
                  href="https://steamcommunity.com/groups/forcaintrepida"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  steam
              ...
              <li className="nav-item">
                <a
                  className="btn-font footer-link"
                  href="https://www.instagram.com/apollogameslab/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  instagram
              ...
              <li className="nav-item">
                <a
                  className="btn-font footer-link"
                  href="https://www.youtube.com/channel/UCLN9FIqyuuGweIFbz2NvdRQ"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  youtube
              ...
              <li className="nav-item">
                <a
                  className="btn-font footer-link"
                  href="https://www.twitch.tv/apollogameslab"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  twitch
          ...
          <div className="footer-brand row">
            <span className="caption-font col-md rights">
              <FormattedMessage id="footer.direitos" />
            </span>
            ...
            <div className="dev col-md">
              <span className="dev-title">
                <FormattedMessage id="footer.develop" />
              </span>
              <a
                className="caption-font"
                href="https://github.com/caiomarqs"
                target="_blank"
                rel="noopener noreferrer"
              >
                @caiomarqs
